...
class RenderFont(object):
    ...
    #     surf_arr, bbs = crop_safe(surf_pixels_alpha, rect_union, bbs, pad=5)
        ...
        for l in lines:
            ...
            for ch in l: # render each character
                ...
                if ch.isdigit() == True:
                    ...
                    ch_bounds = font.render_to(surf, (x,y), ch, rotation=90)
    ...
    def render_sample(self,font,mask):
        ...
        while i < self.max_shrink_trials and max_font_h > self.min_font_h:
            ...
            # text_arr = random.sample('ABCDEFGHIJKLMNOPQRSTUVWXYZ',3) 
            # text = ''.join(text_arr) + 'U' 
            # text2 = random.sample('0123456789',7) 
            # text2 = ''.join(text2) 
            # text = text + text2
